...
class WorkoutScreenLogic8 extends StatefulWidget {
  @override
  _WorkoutScreenLogic8 createState() => _WorkoutScreenLogic8();
}

class _WorkoutScreenLogic8 extends State<WorkoutScreenLogic8> {
  WorkoutRoutine8? routine;
  ...
  Widget build(BuildContext context) {
    routine = ModalRoute.of(context)!.settings.arguments as WorkoutRoutine8?;
...
class WorkoutRoutine8 {
  final String name;
  final List<Exercise8> exercises;

  WorkoutRoutine8({required this.name, required this.exercises});
}

List<WorkoutRoutine8> WorkoutRoutine8s = [
  WorkoutRoutine8(
