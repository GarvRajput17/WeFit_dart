...
class WorkoutScreenLogic7 extends StatefulWidget {
  @override
  _WorkoutScreenLogic7 createState() => _WorkoutScreenLogic7();
}

class _WorkoutScreenLogic7 extends State<WorkoutScreenLogic7> {
  WorkoutRoutine7? routine;
  ...
  Widget build(BuildContext context) {
    routine = ModalRoute.of(context)!.settings.arguments as WorkoutRoutine7?;
...
class WorkoutRoutine7 {
  final String name;
  final List<Exercise7> exercises;

  WorkoutRoutine7({required this.name, required this.exercises});
}

List<WorkoutRoutine7> WorkoutRoutine7s = [
  WorkoutRoutine7(
    name: "Beginner Abs",
    exercises: [
      Exercise7(
