...
class WorkoutScreenLogic5 extends StatefulWidget {
  @override
  _WorkoutScreenLogic5 createState() => _WorkoutScreenLogic5();
}

class _WorkoutScreenLogic5 extends State<WorkoutScreenLogic5> {
  WorkoutRoutine5? routine;
  ...
  Widget build(BuildContext context) {
    routine = ModalRoute.of(context)!.settings.arguments as WorkoutRoutine5?;
...
class WorkoutRoutine5 {
  final String name;
  final List<Exercise5> exercises;

  WorkoutRoutine5({required this.name, required this.exercises});
}

List<WorkoutRoutine5> WorkoutRoutine5s = [
  WorkoutRoutine5(
